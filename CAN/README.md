...
| [Student Labs](Student-Labs.md) | Educational exercises focused on modifying ECU firmware to implement security mitigations, such as message authentication and encryption. |
